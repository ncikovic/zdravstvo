...
export function AppRoutes(): ReactElement {
  return (
    <BrowserRouter>
      <Routes>
        <Route
          path={APP_ROUTES.accountCreated}
        ...
        <Route element={<SystemAdminRoute />}>
          <Route element={<AppLayout />}>
            ...
            <Route
              path={APP_ROUTES.adminUserManage}
              element={<ManageAdminUserPage />}
            />
        ...
        <Route element={<ManagerRoute />}>
          <Route element={<AppLayout />}>
            ...
            <Route
              path={APP_ROUTES.doctorsCreate}
              element={<CreateDoctorPage />}
            />
            <Route
              path={APP_ROUTES.doctorDetails}
              element={<DoctorDetailsPage />}
            />
            <Route path={APP_ROUTES.doctorEdit} element={<EditDoctorPage />} />
            <Route
              path={APP_ROUTES.doctorSchedule}
              element={<DoctorSchedulePage />}
            />
            <Route
              path={APP_ROUTES.doctorExceptions}
              element={<DoctorExceptionsPage />}
            />
            <Route
            ...
            />
            <Route
              path={APP_ROUTES.createAppointmentType}
              element={<CreateAppointmentTypePage />}
            />
            <Route
              path={APP_ROUTES.editAppointmentType}
              element={<EditAppointmentTypePage />}
            />
            <Route path={APP_ROUTES.users} element={<ManagerUsersPage />} />
            <Route
              path={APP_ROUTES.usersCreate}
              element={<CreateManagerUserPage />}
            />
            <Route
              path={APP_ROUTES.usersManage}
              element={<ManageManagerUserPage />}
            />
            <Route
        ...
        <Route element={<AppointmentDetailRoute />}>
          <Route element={<AppLayout />}>
            <Route
              path={APP_ROUTES.appointmentDetails}
        ...
        <Route element={<ScheduleActionRoute />}>
          <Route element={<AppLayout />}>
            <Route
              path={APP_ROUTES.changeAppointment}
              element={<ChangeAppointmentPage />}
            />
            <Route
              path={APP_ROUTES.cancelAppointment}
