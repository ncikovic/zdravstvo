        ...
        <section className="new-patient-card">
          ...
          <div className="new-patient-card__section">
            <div className="new-patient-profile-photo">
              ...
              <span className="new-patient-profile-photo__label">Profilna fotografija</span>
          ...
          {/* Basic Info Section */}
          <div className="new-patient-card__section">
            <h2 className="new-patient-card__section-title">1. Osnovni podaci</h2>
            ...
            <div className="new-patient-fields-row new-patient-fields-row--2">
              <div className="new-patient-field">
                <label className="new-patient-field__label" htmlFor="dateOfBirth">
          ...
          <div className="new-patient-card__section">
            ...
            <div className="new-patient-fields-row new-patient-fields-row--2">
              ...
              <div className="new-patient-field">
                <label className="new-patient-field__label" htmlFor="postalCode">
                  Poštanski broj
                </label>
                <input
                  id="postalCode"
          ...
          <div className="new-patient-card__section">
            <h2 className="new-patient-card__section-title">3. Dodatne informacije</h2>
            ...
            <div className="new-patient-field">
              ...
              <textarea
                ...
                maxLength={500}
              />
              <span className="new-patient-field__count">{formData.notes.length} / 500</span>
            </div>
          </div>

          {/* Emergency Contact Section */}
          <div className="new-patient-card__section">
            <h2 className="new-patient-card__section-title">4. Hitni kontakt</h2>

            <div className="new-patient-field">
              <label className="new-patient-field__label" htmlFor="emergencyContactName">
                Ime i prezime
              </label>
              <input
            ...
            <div className="new-patient-field">
              <label className="new-patient-field__label" htmlFor="emergencyContactPhone">
                Telefon
              </label>
              <div className="new-patient-phone-input">
                <select className="new-patient-phone-code">
          ...
          <div className="new-patient-card__section">
            <h2 className="new-patient-card__section-title">5. Povezivanje s ustanovom</h2>
            ...
            <div className="new-patient-notifications-toggle">
              <label className="new-patient-toggle-label">
                <input
                  ...
                  onChange={(e) => handleInputChange('enableOnlineNotifications', e.target.checked)}
                />
                <span className="new-patient-toggle-switch"></span>
                <span className="new-patient-toggle-text">Omogući online podajetnjke</span>
              </label>
            </div>
          ...
          <div className="new-patient-info-card">
            ...
            <div className="new-patient-info-preview">
              <div className="new-patient-preview-avatar">
                <span>{(formData.firstName[0] || 'N').toUpperCase()}{(formData.lastName[0] || 'P').toUpperCase()}</span>
              </div>
              <div className="new-patient-preview-info">
                <strong>{formData.firstName && formData.lastName ? `${formData.firstName} ${formData.lastName}` : 'Novi pacijent'}</strong>
            ...
            <div className="new-patient-tips-list">
              ...
              <div className="new-patient-tip-item">
                ...
                <div>
                  ...
                  <span>Hitni kontakt može biti klučan u nužnim situacijama.</span>
                </div>
              </div>
            </div>
          </div>
